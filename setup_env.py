    ...
    def create_default_config(self) -> bool:
        ...
        default_config = {
            ...
            "variables": [
                ...
                {"name": "Wm", "bounds": [0.2, 1.5], "unit": "mm", "precision": 2},
            ],
            "objectives": [
                {
                    "type": "s_db",
        ...
        if upgrade:
            ...
            if install_surrogate:
                ...
                self.install_packages(
                    [pkg.split(">=")[0] for pkg in self.SURROGATE_ENHANCED_PACKAGES.values()], upgrade=True
                )
        elif install:
            # 只安装缺失的
            if missing:
